...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActionType.weight'
        db.add_column('times_actiontype', 'weight',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActionType.weight'
        db.delete_column('times_actiontype', 'weight')
