...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActionType.user'
        db.add_column('times_actiontype', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], blank=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActionType.user'
        db.delete_column('times_actiontype', 'user_id')
    ...
    models = {
        ...
        'times.actiontype': {
            'Meta': {'ordering': "('weight',)", 'object_name': 'ActionType'},
